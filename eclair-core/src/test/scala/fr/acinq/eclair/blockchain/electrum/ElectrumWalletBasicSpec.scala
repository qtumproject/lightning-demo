...
//    assert(Base58Check.encode(Base58.Prefix.PubkeyAddressTestnet, priv.publicKey.hash160) == "qVBUTn2rxBup6WygxAJYaJHj5fQifUzQKn")
//    assert(segwitAddress(priv, Block.RegtestGenesisBlock.hash) == "mGZ4ALdkHwgx2tYbhrz5Bu6eTaEMe5mfRa")
//  }
//
...
//    assert(segwitAddress(firstKey, Block.RegtestGenesisBlock.hash) === "mMEn4a6dEuZxJKg1DHkzSH8Yfa9pP9uZ7D")
//  }
//

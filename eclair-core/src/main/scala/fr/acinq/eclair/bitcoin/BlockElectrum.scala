...
/**
  ...
  */
case class BlockHeaderElectrum(version: Long, hashPreviousBlock: BinaryData, hashMerkleRoot: BinaryData, time: Long, bits: Long, nonce: Long) extends BtcSerializable[BlockHeaderElectrum] {
  ...
  lazy val hash: BinaryData = Crypto.hash256(BlockHeaderElectrum.write(this))
...
object BlockElectrum extends BtcSerializer[BlockElectrum] {
  override def read(input: InputStream, protocolVersion: Long): BlockElectrum = {
    ...
    val header = BlockHeaderElectrum.read(raw)
  ...
  val LivenetGenesisBlock = {
    ...
    BlockElectrum(
      BlockHeaderElectrum(version = 1, hashPreviousBlock = Hash.Zeroes, hashMerkleRoot = "3ba3edfd7a7b12b27ac72c3e67768f617fc81bc3888a51323a9fb8aa4b1e5e4a", time = 1231006505, bits = 0x1d00ffff, nonce = 2083236893),
      List(
